...
INSERT INTO question (numero, intitule, idUser) VALUES
    (1, 'Qui a dit que 1+1 pouvait faire "mÃªme peut-Ãªtre 11" ?', 10)
    ,(2, "En combien d'heures les protagonistes du 'Tour de monde' en 80 jours de Jules Verne font-ils le tour du monde ?", 10)
    ,(3, "Dans les Simpson, le gérant du bar s'appelle :", 10)
    ,(4, "Qui n'a jamais combattu Dracula au cinéma ?", 10)
    ,(5, "Laquelle de ces peintures n'existe pas ?", 10)
    ,(6, "Quelle raplique est tirage du film 'Fantomas' de André Hunnebelle ?", 10)
    ,(7, "Qu'est-ce qui est surpenant quand David Banner se transforme en Hulk ?", 10)
    ,(8, "Jean-Claude Vandamme a déclaré dans Première : Je suis fasciné par l'air. Si vous enlever l'air du ciel...", 10)
    ,(9, 'En plongée, qui signifie le geste pouce et index joints faisant un cercle ?', 10)
    ,(10, "Qu'est-ce que la kénophobie ?", 10)
    ,(11, "Quel gang n'a jamais existé au cinéma ?", 10)
    ,(12, "Un anglais a reçu un avertissement de la SPA anglaise parce qu'il :", 10)
    ,(13, 'Quel est le point commun ente Janis Joplin, Jimi Hendrix et Jim Morisson ? ', 10)
    ,(14, "Quelle est la durée de vie d'un termite ?", 10)
    ,(15, "Une seule de ces chansons de Fancky Vincent n'est pas dans l'album Franky Vincent ?", 10)
    ,(16, "A quoi s'intéresse-t-on quand on fait de la potamologie ?", 10)
    ,(17, "Que signifie le nom du groupe corse 'I Muvrini' ?", 10)
    ,(18, 'Laquelle de ces montagnes existe ?', 10)
    ,(19, "Qu'est-ce qu'une ploutocratie ?", 10)
    ,(20, "En l'an 2000, combien de personnes ont été tuées par des requins ?", 10)
    ,(21, "Comment est mort l'inventeur du parachute ?", 10)
    ,(22, 'Yamakasi veut dire :', 10)
    ,(23, 'Quel est le nom de la petite Sirène de Disney ?', 10)
    ,(24, 'Pourquoi les autruches enfouissent-elles leut tête dans le sol ?', 10)
    
;

INSERT TO proposition (lettre, intitule, estBonneReponse, idQuestion) VALUES
    ...
    ,(B, "Dracula conte Frankenstein", 0, 4)
    ,(C, "Billy le Kid conte Dracula", 0, 4)
    ,(D, "racula conte Godzilla", 1, 4)
    ...
    ,(B, "Il ne pense pas Ã  faire du yoga", 0, 7)
    ,(C, "Il dÃ©chire tous ses vétements, sauf son short et son caleçon. C'est fou, il a une toute petite bite finalement !", 1, 7)
    ...
    ,(D, "Vas-y, vise lÃ  dedans avec ton harpon", 0, 9)
    ...
    ,(B, "La gang des chanteurs Ã  moustache", 1, 11)
    ,(C, "Le gang des pianos Ã  bretelle", 0, 11)
    ...
    ,(C, "Ils sont tous morts au mÃªme Ã¢ge, 27 ans", 0, 13)
    ...
    ,(A, "Un régime politique oÃ¹ le pouvoir appartient aux plus fortunés.", 1, 19)
    ,(B, "Un régime politique merveilleux ou le pouvoir appartient Ã  Pluto et Ã  tous ces amis", 0, 19)
    ,(C, "Un régime politique où le pouvoir appartient aux plus forts", 0, 19)
    ,(D, "Un régime amaincissant Ã  base de ploutes", 0, 19)
    ...
    ,(B, "Pour protÃ©ger leurs oeufs", 1, 24)
